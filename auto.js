...
zzz.get.cls("subTitle").innerText="显示/隐藏不要的";
zzz.get.cls("subTitle").nextElementSibling.innerText="与满的";
zzz.get.cls("subTitle").nextElementSibling.onclick=function(){hideFull(!status_hideFull);};
