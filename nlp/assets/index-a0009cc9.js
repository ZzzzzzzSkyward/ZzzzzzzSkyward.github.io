  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _hoisted_2$3,
        !__props.sticky ? (openBlock(), createElementBlock("h3", _hoisted_3$3, "nlp-chinese-poetry-appreciation")) : createCommentVNode("", true),
        !__props.sticky ? (openBlock(), createElementBlock("span", _hoisted_4$2, "\xA0")) : createCommentVNode("", true),
...
const _sfc_main$1 = {
  ...
  methods: {
    focus: function(el) {
      ...
      el.chain().focus().run();
      window.inputel = this.input;
    },
    togglealign(e) {
      let el = document.getElementById("centralize");
      if (el.align == "center") {
        el.align = "left";
        el.classList.remove("forcehover");
        this.input.view.dom.classList.remove("text-center");
      } else {
        el.align = "center";
        el.classList.add("forcehover");
        this.input.view.dom.classList.add("text-center");
      }
    },
    clearinput() {
      this.input.commands.clearContent();
    },
    startloading: function() {
      ...
      this.loadbutton = document.getElementById("run");
      this.loadbutton.classList.add("is_disabled");
      this.runupdatetask();
      this.connectserver();
    },
    connectserver: function() {
      ...
      let data = this.input.getText({ blockSeparator: "\n" });
    ...
    fetchdata: function(data) {
      ...
      if (data.content) {
        this.output.commands.setContent(data.content);
      }
      this.stoploading();
    },
    stoploading: function() {
      ...
      if (this.updatetaskpertick) {
        clearInterval(this.updatetaskpertick);
        this.updatetaskpertick = null;
      }
      this.loadbutton.classList.remove("is_disabled");
    },
    updateloadingtips: function(that, tips) {
      console.log(that, this);
      let total_time = 500;
      let time_per_tip = Math.max(Math.floor(total_time / tips.length), 30);
      let i2 = 1;
      this.updatetaskpertick = setInterval(() => {
        if (i2 >= tips.length) {
          clearInterval(this.updatetaskpertick);
          this.updatetaskpertick = null;
        }
        this.loading_tips = tips.substring(0, i2);
        i2++;
      }, time_per_tip);
    },
    ...
    runupdatetask: function() {
      this.updateloadingtips(this, this.getloadingtips());
      let that = this;
...
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("span", null, "\u8BD7", -1);
...
const _hoisted_9 = /* @__PURE__ */ createBaseVNode("span", null, "\u6E05\u7A7A", -1);
...
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("span", null, "\u5C45\u4E2D", -1);
...
const _hoisted_16 = /* @__PURE__ */ createBaseVNode("div", { class: "area_title font-title" }, "\u9274\u8D4F", -1);
const _hoisted_17 = {
  id: "loading_mask",
  class: "loading_area fasttrans flex center disable-select"
};
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("span", {
  id: "loading_mask_mouse",
  class: "blink"
}, "|", -1);
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    createBaseVNode("div", _hoisted_2$1, [
      createBaseVNode("div", _hoisted_3$1, [
        ...
        createBaseVNode("div", _hoisted_5, [
          ...
          createBaseVNode("div", {
            id: "centralize",
            onClick: _cache[2] || (_cache[2] = (...args) => $options.togglealign && $options.togglealign(...args))
          }, _hoisted_14)
        ])
      ]),
      createBaseVNode("div", {
        ...
        onClick: _cache[3] || (_cache[3] = ($event) => $options.focus(this.input))
      }, [
    ...
    createBaseVNode("div", _hoisted_15, [
      ...
      createBaseVNode("div", {
        ...
        class: "area_text fasttrans",
        onClick: _cache[4] || (_cache[4] = ($event) => $options.focus(this.output))
      }, [
        ...
        createBaseVNode("div", _hoisted_17, [
          createTextVNode(toDisplayString(_ctx.loading_tips), 1),
          _hoisted_18
        ])
      ])
    ])
...
const _hoisted_2 = { class: "fullpage center flexv fasttrans" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("img", {
  id: "logo",
  alt: "logo",
  src: _imports_0
}, null, -1);
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { id: "footer" }, [
